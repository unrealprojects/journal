...
<div id="yoo-zoo" class="yoo-zoo <?php echo $css_class; ?> <?php echo $css_class.'-frontpage'; ?>">
	...
	<div class="details <?php echo 'alignment-'.$this->params->get('template.alignment'); ?>">
		...
		<h1 class="title">
			...
			<?php echo $this->application->getParams()->get('content.title'); ?>

			<?php if ($this->application->getParams()->get('content.subtitle')) : ?>
				<span class="subtitle"> - <?php echo $this->application->getParams()->get('content.subtitle'); ?></span>
			<?php endif; ?>
	...
	<?php
		...
		if (count($this->items)) {
			...
			$subtitle = $this->application->getParams()->get('content.items_subtitle');
