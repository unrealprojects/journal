...
(1, 0, 0, 574, 0, 'root.1', 'Root Asset', '{"core.login.site":{"6":1,"2":1},"core.login.admin":{"6":1},"core.login.offline":{"6":1},"core.admin":{"8":1},"core.manage":{"7":1},"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
...
(18, 1, 289, 408, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1},"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(19, 1, 409, 412, 1, 'com_newsfeeds', 'com_newsfeeds', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(20, 1, 413, 414, 1, 'com_plugins', 'com_plugins', '{"core.admin":{"7":1},"core.manage":[],"core.edit":[],"core.edit.state":[]}'),
(21, 1, 415, 416, 1, 'com_redirect', 'com_redirect', '{"core.admin":{"7":1},"core.manage":[]}'),
(22, 1, 417, 418, 1, 'com_search', 'com_search', '{"core.admin":{"7":1},"core.manage":{"6":1}}'),
(23, 1, 419, 420, 1, 'com_templates', 'com_templates', '{"core.admin":{"7":1},"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(24, 1, 421, 424, 1, 'com_users', 'com_users', '{"core.admin":{"7":1},"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(25, 1, 425, 428, 1, 'com_weblinks', 'com_weblinks', '{"core.admin":{"7":1},"core.manage":{"6":1},"core.create":{"3":1},"core.delete":[],"core.edit":{"4":1},"core.edit.state":{"5":1},"core.edit.own":[]}'),
(26, 1, 429, 430, 1, 'com_wrapper', 'com_wrapper', '{}'),
...
(30, 19, 410, 411, 2, 'com_newsfeeds.category.5', 'Без категории', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(31, 25, 426, 427, 2, 'com_weblinks.category.6', 'Без категории', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[],"core.edit.own":[]}'),
(32, 24, 422, 423, 1, 'com_users.category.7', 'Без категории', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(33, 1, 431, 432, 1, 'com_finder', 'com_finder', '{"core.admin":{"7":1},"core.manage":{"6":1}}'),
(34, 1, 433, 434, 1, 'com_joomlaupdate', 'com_joomlaupdate', '{"core.admin":[],"core.manage":[],"core.delete":[],"core.edit.state":[]}'),
(35, 1, 435, 436, 1, 'com_tags', 'com_tags', '{"core.admin":[],"core.manage":[],"core.manage":[],"core.delete":[],"core.edit.state":[]}'),
(36, 1, 437, 438, 1, 'com_contenthistory', 'com_contenthistory', '{}'),
(37, 1, 439, 440, 1, 'com_ajax', 'com_ajax', '{}'),
(38, 1, 441, 442, 1, 'com_postinstall', 'com_postinstall', '{}'),
...
(54, 1, 443, 444, 1, 'com_jsecure', 'jsecure', '{}'),
(55, 1, 445, 446, 1, 'com_jce', 'jce', '{}'),
(56, 1, 447, 448, 1, 'com_xmap', 'com_xmap', '{}'),
(57, 1, 449, 452, 1, 'com_djimageslider', 'com_djimageslider', '{}'),
(58, 18, 320, 321, 2, 'com_modules.module.87', 'Слайдер', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
(59, 57, 450, 451, 2, 'com_djimageslider.category.8', 'Без категории', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
...
(113, 1, 475, 476, 1, '#__ucm_content.12', '#__ucm_content.12', '[]'),
...
(129, 1, 491, 492, 1, '#__ucm_content.20', '#__ucm_content.20', '[]'),
...
(179, 1, 539, 540, 1, '#__ucm_content.44', '#__ucm_content.44', '[]'),
...
(181, 1, 541, 542, 1, '#__ucm_content.45', '#__ucm_content.45', '[]'),
...
(183, 1, 543, 544, 1, '#__ucm_content.46', '#__ucm_content.46', '[]'),
...
(185, 1, 545, 546, 1, '#__ucm_content.47', '#__ucm_content.47', '[]'),
...
(261, 1, 561, 562, 1, 'com_widgetkit', 'widgetkit', '{}'),
(271, 18, 364, 365, 2, 'com_modules.module.109', 'trdgsergsergsed', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(276, 1, 563, 568, 1, 'com_zoo.application.3', 'journal', '{"core.admin":{"8":1},"core.manage":{"7":1},"zoo.categories.manage":[],"zoo.comments.manage":[],"zoo.frontpage.manage":[],"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
...
(282, 1, 570, 571, 1, 'com_acymailing', 'acymailing', '{}'),
...
(303, 18, 406, 407, 2, 'com_modules.module.130', 'Реклама', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}');
...
(695, 'arena pharmaceuticals для', 'arena pharmaceuticals для', 0, 1, 1.8333, 'A6516523242', 2, '*'),
(696, 'pharmaceuticals', 'pharmaceuticals', 0, 0, 1, 'P6523242', 2, '*'),
(697, 'pharmaceuticals для', 'pharmaceuticals для', 0, 1, 1.6333, 'P6523242', 2, '*'),
(698, 'pharmaceuticals для лечения', 'pharmaceuticals для лечения', 0, 1, 1.9, 'P6523242', 2, '*'),
(699, 'артериальной', 'артериальной', 0, 0, 0.8, 'а000', 2, '*'),
(700, 'артериальной гипертензии', 'артериальной гипертензии', 0, 1, 1.8, 'а000', 2, '*'),
(701, 'артериальной гипертензии получил', 'артериальной гипертензии получил', 0, 1, 2, 'а000', 2, '*'),
(702, 'в', 'в', 0, 0, 0.0667, 'в000', 2, '*'),
(703, 'в сша', 'в сша', 0, 1, 1.1667, 'в000', 2, '*'),
(704, 'в сша статус', 'в сша статус', 0, 1, 1.4, 'в000', 2, '*'),
...
(712, 'компании arena', 'компании arena', 0, 1, 1.4667, 'к650', 2, '*'),
(713, 'компании arena pharmaceuticals', 'компании arena pharmaceuticals', 0, 1, 2, 'к6516523242', 2, '*'),
(714, 'легочной', 'легочной', 0, 0, 0.5333, 'л000', 2, '*'),
(715, 'легочной артериальной', 'легочной артериальной', 0, 1, 1.7, 'л000', 2, '*'),
(716, 'легочной артериальной гипертензии', 'легочной артериальной гипертензии', 0, 1, 2, 'л000', 2, '*'),
(717, 'лечения', 'лечения', 0, 0, 0.4667, 'л000', 2, '*'),
(718, 'лечения легочной', 'лечения легочной', 0, 1, 1.5333, 'л000', 2, '*'),
(719, 'лечения легочной артериальной', 'лечения легочной артериальной', 0, 1, 1.9667, 'л000', 2, '*'),
(720, 'орфанного', 'орфанного', 0, 0, 0.6, 'о000', 2, '*'),
(721, 'получил', 'получил', 0, 0, 0.4667, 'п000', 2, '*'),
(722, 'получил в', 'получил в', 0, 1, 1.3, 'п000', 2, '*'),
(723, 'получил в сша', 'получил в сша', 0, 1, 1.4333, 'п000', 2, '*'),
(724, 'препарат', 'препарат', 0, 0, 0.5333, 'п000', 2, '*'),
(725, 'препарат компании', 'препарат компании', 0, 1, 1.5667, 'п000', 2, '*'),
(726, 'препарат компании arena', 'препарат компании arena', 0, 1, 1.7667, 'п650', 2, '*'),
(727, 'статус', 'статус', 0, 0, 0.4, 'с000', 2, '*'),
(728, 'статус орфанного', 'статус орфанного', 0, 1, 1.5333, 'с000', 2, '*'),
...
(9, '89335a61-ea45-4fad-b16f-488154d4f8e2', 'іпкаівапівапфвкпфувкрфукарвіфарівер'),
(10, 'b9bab2fd-a9cc-47ac-8473-71d232f2bfb6', '5.0'),
(8, '89335a61-ea45-4fad-b16f-488154d4f8e2', 'іпкаівапівапфвкпфувкрфукарвіфарівер'),
(9, 'b9bab2fd-a9cc-47ac-8473-71d232f2bfb6', '0.0'),
