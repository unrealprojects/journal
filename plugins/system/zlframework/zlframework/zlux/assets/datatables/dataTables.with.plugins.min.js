 ...
 */
(function(la,s,p){(function(i){if(typeof define==="function"&&define.amd&&false)define(["jquery"],i);else jQuery&&!jQuery.fn.dataTable&&i(jQuery)})(function(i){var l=function(h){function n(a,b){var c=l.defaults.columns,d=a.aoColumns.length;b=i.extend({},l.models.oColumn,c,{sSortingClass:a.oClasses.sSortable,sSortingClassJUI:a.oClasses.sSortJUI,nTh:b?b:s.createElement("th"),sTitle:c.sTitle?c.sTitle:b?b.innerHTML:"",aDataSort:c.aDataSort?c.aDataSort:[d],mData:c.mData?c.oDefaults:d});a.aoColumns.push(b);if(a.aoPreSearchCols[d]===
...
/* Plugins - ZLUX related */
(function(b){jQuery.fn.dataTableExt.oApi.fnGetColumnData=function(a,b,c,d,e){if("undefined"==typeof b)return[];"undefined"==typeof c&&(c=!0);"undefined"==typeof d&&(d=!0);"undefined"==typeof e&&(e=!0);a=!0==d?a.aiDisplay:a.aiDisplayMaster;d=[];for(var g=0,h=a.length;g<h;g++){iRow=a[g];var k=this.fnGetData(iRow,b);if(!0!=e||0!=k.length)!0==c&&-1<jQuery.inArray(k,d)||d.push(k)}return d};b.fn.dataTableExt.oApi.fnReloadAjax=function(a,b,c,d){"undefined"!=typeof b&&null!=b&&(a.sAjaxSource=b);if(a.oFeatures.bServerSide)this.fnDraw(); else{this.oApi._fnProcessingDisplay(a,!0);var e=this,g=a._iDisplayStart;b=[];this.oApi._fnServerParams(a,b);a.fnServerData.call(a.oInstance,a.sAjaxSource,b,function(b){e.oApi._fnClearTable(a);b=""!==a.sAjaxDataProp?e.oApi._fnGetObjectDataFn(a.sAjaxDataProp)(b):b;for(var f=0;f<b.length;f++)e.oApi._fnAddData(a,b[f]);a.aiDisplay=a.aiDisplayMaster.slice();"undefined"!=typeof d&&!0===d?(a._iDisplayStart=g,e.fnDraw(!1)):e.fnDraw();e.oApi._fnProcessingDisplay(a,!1);"function"==typeof c&&null!=c&&c(a)},a)}}; b.fn.dataTableExt.aoFeatures.push({fnInit:function(a){return new p(a)},cFeature:"F",sFeature:"Filtering"});var p=function(a){var f=b('<div class="zlux-x-filter-input_wrapper" />'),c=null;b('<input type="text" class="zlux-x-filter-input" />').on("keyup",function(d){var e=b(this).val();clearTimeout(c);""==e&&n(a,"");13==(d.keyCode?d.keyCode:d.which)&&n(a,e);c=setTimeout(function(){n(a,e)},500)}).appendTo(f);return f[0]},n=function(a,b){b!=a.oPreviousSearch.sSearch&&a.oInstance.fnFilter(b)};b.extend(!0, b.fn.dataTable.defaults,{sDom:"<'row-fluid'<'span6'l><'span6'f>r>t<'row-fluid'<'span6'i><'span6'p>>",sPaginationType:"bootstrap",oLanguage:{sProcessing:'<span class="zlux-loader-circle-big"></span>',sLengthMenu:"_MENU_ records per page"},bProcessing:!1,bLengthChange:!1});b.extend(b.fn.dataTableExt.oStdClasses,{sWrapper:"dataTables_wrapper form-horizontal zlux-datatables",sStripeOdd:"",sStripeEven:""});b.fn.dataTableExt.oApi.fnPagingInfo=function(a){return{iStart:a._iDisplayStart,iEnd:a.fnDisplayEnd(), iLength:a._iDisplayLength,iTotal:a.fnRecordsTotal(),iFilteredTotal:a.fnRecordsDisplay(),iPage:-1===a._iDisplayLength?0:Math.ceil(a._iDisplayStart/a._iDisplayLength),iTotalPages:-1===a._iDisplayLength?0:Math.ceil(a.fnRecordsDisplay()/a._iDisplayLength)}};var q=function(a){a.aoDrawCallback.push({fn:function(){for(var b=1<a.oInstance.fnPagingInfo().iTotalPages,c=0,d=a.aanFeatures.p.length;c<d;c++)a.aanFeatures.p[c].style.display=b?"block":"none"},sName:"PagingControl"})};b.fn.dataTableExt.aoFeatures.push({fnInit:function(a){new q(a)}, cFeature:"P",sFeature:"PagingControl"});b.extend(b.fn.dataTableExt.oPagination,{bootstrap:{fnInit:function(a,f,c){var d=function(b){b.preventDefault();a.oApi._fnPageChange(a,b.data.action)&&c(a)};b(f).addClass("pagination").append('<ul class="zlux-x-pagination"><li class="first disabled"><a href="#" class="zlux-x-btn"><i class="icon-double-angle-left"></i></a></li><li class="prev disabled"><a href="#" class="zlux-x-btn"><i class="icon-angle-left"></i></a></li><li class="next disabled"><a href="#" class="zlux-x-btn"><i class="icon-angle-right"></i></a></li><li class="last disabled"><a href="#" class="zlux-x-btn"><i class="icon-double-angle-right"></i></a></li></ul>'); f=b("a",f);b(f[0]).bind("click.DT",{action:"first"},d);b(f[1]).bind("click.DT",{action:"previous"},d);b(f[2]).bind("click.DT",{action:"next"},d);b(f[3]).bind("click.DT",{action:"last"},d)},fnUpdate:function(a,f){var c=a.oInstance.fnPagingInfo(),d=a.aanFeatures.p,e,g,h,k,l,m;e=Math.floor(2);4>c.iTotalPages?(l=1,m=c.iTotalPages):c.iPage<=e?(l=1,m=4):c.iPage>=c.iTotalPages-e?(l=c.iTotalPages-4+1,m=c.iTotalPages):(l=c.iPage-e+1,m=l+4-1);e=0;for(g=d.length;e<g;e++){b("li:gt(1)",d[e]).filter(":not(:last)").not(".next").remove(); for(h=l;h<=m;h++)k=h==c.iPage+1?'class="active"':"",b("<li "+k+'><a href="#">'+h+"</a></li>").insertBefore(b("li.next, li.last",d[e])[0]).bind("click",function(d){d.preventDefault();a._iDisplayStart=(parseInt(b("a",this).text(),10)-1)*c.iLength;f(a)});0===c.iPage?b("li.first, li.prev",d[e]).addClass("disabled"):b("li.first, li.prev",d[e]).removeClass("disabled");c.iPage===c.iTotalPages-1||0===c.iTotalPages?b("li.next, li.last",d[e]).addClass("disabled"):b("li.next, li.last",d[e]).removeClass("disabled")}}}})})(jQuery);