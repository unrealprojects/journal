			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<?php if ($this->preview && $item->client_id == '0') : ?>
						...
						<i class="icon-eye-open " title="<?php echo JHtml::tooltipText(JText::_('COM_TEMPLATES_TEMPLATE_PREVIEW'), $item->title, 0); ?>" ></i></a>
					<?php elseif ($item->client_id == '1') : ?>
						<i class="icon-eye-close disabled " title="<?php echo JHtml::tooltipText('COM_TEMPLATES_TEMPLATE_NO_PREVIEW_ADMIN'); ?>" ></i>
					<?php else: ?>
						<i class="icon-eye-close disabled " title="<?php echo JHtml::tooltipText('COM_TEMPLATES_TEMPLATE_NO_PREVIEW'); ?>" ></i>
					<?php endif; ?>
					<?php if ($canEdit) : ?>
				...
				<td class="center">
					<?php if ($item->assigned > 0) : ?>
						<i class="icon-ok tip " title="<?php echo JHtml::tooltipText(JText::plural('COM_TEMPLATES_ASSIGNED', $item->assigned), '', 0); ?>"></i>
					<?php else : ?>
						&#160;
					<?php endif; ?>
				</td>
