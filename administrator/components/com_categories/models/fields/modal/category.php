...
class JFormFieldModal_Category extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html[] = '<a class="modal btn " title="' . JHtml::tooltipText('COM_CATEGORIES_CHANGE_CATEGORY') . '"  href="' . $link . '&amp;' . JSession::getFormToken() . '=1" rel="{handler: \'iframe\', size: {x: 800, y: 450}}"><i class="icon-file"></i> ' . JText::_('JSELECT') . '</a>';

		// Edit category button
		if ($allowEdit)
		{
			$html[] = '<a class="btn ' . ($value ? '' : ' hidden') . '" href="index.php?option=com_categories&layout=modal&tmpl=component&task=category.edit&id=' . $value . '" target="_blank" title="' . JHtml::tooltipText('COM_CATEGORIES_EDIT_CATEGORY') . '" ><span class="icon-edit"></span> ' . JText::_('JACTION_EDIT') . '</a>';
		}
