...
class JHtmlIcon
{
	public static function create($weblink, $params)
	{
		...
		$output = '<span class="" title="' . JHtml::tooltipText('COM_WEBLINKS_FORM_CREATE_WEBLINK') . '">' . $button . '</span>';
		return $output;
	}
	...
	public static function edit($weblink, $params, $attribs = array())
	{
		...
		$output = '<span class="" title="' . JHtml::tooltipText('COM_WEBLINKS_EDIT') . ' :: ' . $overlib . '">' . $button . '</span>';
